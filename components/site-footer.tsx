...
export function SiteFooter({ theme = "dark" }: SiteFooterProps) {
  ...
  const linkHover = theme === "pink" ? "hover:text-[#0a090b] focus-visible:text-[#0a090b]" : "hover:text-[var(--nube-accent-text)]";
      ...
      <div className="grid gap-7 text-center min-[901px]:grid-cols-[1fr_auto_1fr] min-[901px]:items-end min-[901px]:text-left">
        <div className="justify-self-center min-[901px]:justify-self-start">
          ...
          <div className="mt-2 flex flex-wrap items-center justify-center gap-x-5 gap-y-1 min-[901px]:justify-start">
            <a className={`inline-flex min-h-11 items-center gap-2 text-[14px] transition ${linkHover}`} href={contactEmailUrl}>
