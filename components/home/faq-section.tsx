  ...
  return (
    <section id="faq" className="scroll-mt-24 bg-[#f1efe9] px-[clamp(24px,7vw,110px)] py-[clamp(80px,10vw,140px)] text-[#0a0a0d]">
      <div className="grid gap-12 min-[901px]:grid-cols-[.65fr_1.35fr]">
        <div><p className="mb-5 text-[11px] font-black tracking-[.18em] opacity-70">FAQ</p><h2 className="m-0 text-[clamp(46px,6vw,82px)] leading-[.92] tracking-[-.06em]">AVANT<br /><em className="font-[Georgia] font-normal text-[#ff66c4]">DE VENIR.</em></h2></div>
