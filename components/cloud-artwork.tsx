...
const orb =
  "absolute rounded-full bg-[radial-gradient(circle_at_35%_28%,#ffa9d1_0,#ff4aa0_25%,#a52479_60%,#27122f_100%)] shadow-[inset_-25px_-30px_60px_rgba(0,0,0,.5),0_0_50px_rgba(255,42,145,.15)]";

export function CloudArtwork({ topLabel, bottomLabel, className = "" }: CloudArtworkProps) {
  return (
    <div className={`absolute right-[-23vw] top-[55%] z-2 aspect-square w-[75vw] opacity-75 saturate-110 min-[581px]:right-[-8vw] min-[581px]:top-[48%] min-[581px]:w-[65vw] min-[901px]:right-[clamp(-110px,-2vw,-25px)] min-[901px]:top-[18%] min-[901px]:w-[min(43vw,650px)] min-[901px]:opacity-100 ${className}`} aria-hidden="true">
