  ...
  return (
    <main id="main-content" tabIndex={-1}>
      ...
      <section id="top" className={`${section} flex min-h-[68svh] items-end overflow-hidden bg-[#f1efe9] pt-40 text-[#0a0a0d]`}>
        <div className="relative z-2"><p className={index}>LE FESTIVAL · LAUSANNE</p><h1 className="m-0 text-[clamp(44px,9vw,120px)] leading-[.92] tracking-[-.08em]">PAS SEULEMENT<br /><span className="sr-only"> </span><em className="font-[Georgia] font-normal text-[#ff66c4]">UN CONCERT.</em></h1><p className="mt-10 max-w-xl text-[clamp(16px,1.6vw,23px)] leading-[1.6] text-[#4f4b52]">NUBE accompagne les artistes pour faire exister une identité, une histoire et une scène qui leur appartient.</p><div className="mt-8 flex flex-wrap items-center gap-x-6 gap-y-4"><a className="border-b border-black/45 pb-2 text-[12px] font-black tracking-[.12em]" href="#methode">DÉCOUVRIR LA MÉTHODE</a><Link className="border-b border-black/45 pb-2 text-[12px] font-black tracking-[.12em]" href="/archives">VOIR NUBE #1</Link><a className="bg-[#0a090b] px-5 py-4 text-[12px] font-black tracking-[.12em] text-white" href="#edition">SUIVRE NUBE #2</a></div></div>
      </section>

      <section id="methode" className={`${section} bg-[#f1efe9] text-[#0a0a0d]`}>
        <div className="grid gap-12 min-[901px]:grid-cols-[.72fr_1.28fr] min-[901px]:gap-20">
          <div className="min-[901px]:sticky min-[901px]:top-36 min-[901px]:self-start"><p className={index}>NOTRE MANIÈRE DE FAIRE</p><h2 className="m-0 text-[clamp(44px,6vw,76px)] leading-[.92] tracking-[-.065em]">FAIRE<br /><span className="sr-only"> </span><em className="font-[Georgia] font-normal text-[#ff66c4]">ÉMERGER.</em></h2></div>
