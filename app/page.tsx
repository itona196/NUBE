    ...
    <main>
      ...
      <section className={`${section} overflow-hidden bg-[#09090b]`}>
        <div className="grid items-center gap-12 min-[901px]:grid-cols-[1.2fr_.8fr]">
          <div className="relative aspect-video overflow-hidden border border-white/15 bg-[radial-gradient(circle_at_65%_40%,#8e1c5a,#171219_45%,#09090b)]"><Image className="object-contain object-[82%_50%] opacity-70" src="/nube-logo.png" alt="" fill sizes="(max-width: 900px) 100vw, 60vw" /><span className="absolute bottom-5 left-5 z-2 text-[11px] font-black tracking-[.17em]">NUBE #1 · 21.06.2026</span></div>
      ...
      <section className="relative flex min-h-[540px] flex-col items-center justify-center overflow-hidden bg-[#ff66c4] px-6 pb-40 pt-20 text-center text-[#0a090b]">
        ...
        <div className="relative z-2">
          ...
          <h2 className="my-8 text-[clamp(44px,7vw,92px)] leading-[.92] tracking-[-.065em]">UN PROJET.<br /><em className="font-[Georgia] font-normal text-white">TOUT UN MONDE.</em></h2>
        ...
        <SiteFooter tagline="CONTINUER À CRÉER" copyright="NUBE" darkBorder links={[{ href: "/festival", label: "FESTIVAL" }, { href: "/artistes", label: "ARTISTES" }, { href: "/infos", label: "INFOS" }]} />
      </section>
    </main>
  );
}
