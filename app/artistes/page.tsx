  ...
  return (
    <main className="min-h-screen bg-[#f1efe9] text-[#0a0a0d]">
      ...
      <section className="px-[clamp(24px,7vw,110px)] pb-[clamp(90px,11vw,170px)] pt-[clamp(150px,16vw,230px)]">
        ...
        <h1 className="mb-14 mt-0 text-[clamp(42px,9vw,118px)] min-[581px]:mb-20 leading-[.92] tracking-[-.08em]">SEPT ARTISTES.<br /><em className="font-[Georgia] font-normal text-[#ff66c4]">SEPT UNIVERS.</em></h1>
      ...
      <section className="grid gap-8 bg-[#0a090b] px-[clamp(24px,7vw,110px)] py-[clamp(72px,9vw,120px)] text-[#f1efe9] min-[901px]:grid-cols-[1fr_auto] min-[901px]:items-end">
        <div><p className="mb-5 text-[11px] font-black tracking-[.18em] text-white/55">APRÈS LA SCÈNE</p><h2 className="m-0 text-[clamp(42px,6vw,78px)] leading-[.92] tracking-[-.06em]">LEURS PASSAGES<br /><em className="font-[Georgia] font-normal text-[#ff66c4]">RESTENT.</em></h2></div>
