  ...
  return (
    <main className="bg-[#09090b]">
      ...
      <section id="top" className="nube-dream-sky relative flex min-h-[680px] flex-col justify-start overflow-hidden px-[clamp(24px,7vw,110px)] pb-20 pt-[150px] min-[581px]:min-h-[72svh] min-[581px]:justify-center">
        <p className="absolute left-[clamp(24px,7vw,110px)] top-[108px] text-[12px] font-extrabold tracking-[.23em] text-[#aaa5ad] min-[581px]:top-[125px]"><span className="mr-2 inline-block h-1.5 w-1.5 rounded-full bg-[#ff66c4] shadow-[0_0_12px_#ff66c4]" /> MÉMOIRE VIVANTE · LAUSANNE</p><p className={`${index} relative z-2 !mb-[22px]`}>NUBE / DEPUIS 2026</p><h1 className="relative z-2 m-0 text-[48px] leading-[.98] min-[360px]:text-[56px] min-[380px]:text-[64px] min-[581px]:leading-[.92] tracking-[-.085em] min-[581px]:text-[clamp(72px,11vw,140px)]">NOS<br /><em className="font-[Georgia] font-normal text-[#ff66c4]">ARCHIVES.</em></h1><p className="relative z-2 mt-[46px] max-w-[480px] text-[13px] leading-[1.7] text-[#aaa5ae] min-[581px]:ml-[8vw] min-[581px]:text-[15px]">Chaque édition devient un chapitre : ses artistes, ses images, ses coulisses et les mondes créés ensemble.</p><div className="absolute right-[-20vw] top-[46%] z-2 grid aspect-square w-[75vw] place-items-center rounded-full border border-white/20 opacity-55 before:absolute before:inset-[17%] before:rounded-full before:border before:border-white/15 min-[581px]:right-[-5vw] min-[581px]:top-[24%] min-[581px]:w-[min(32vw,460px)] min-[901px]:right-[6vw] min-[901px]:opacity-100" aria-hidden="true"><span className="absolute right-[8%] top-[46%] z-2 font-[Georgia] text-[15px] italic">01</span><Image className="object-contain p-[6%] drop-shadow-[0_0_40px_rgba(255,63,152,.42)]" src="/nube-logo.png" alt="" fill sizes="(max-width: 580px) 75vw, (max-width: 900px) 32vw, 460px" /></div>
      </section>
      ...
      <section id="edition-one" className={`${section} bg-[#f1efe9] text-[#0a0a0d]`}>
        ...
        <div className="mt-[30px] grid gap-[18px] border-t border-[#bbb5ad] pt-[25px] min-[581px]:grid-cols-[.5fr_1fr_.5fr] min-[581px]:gap-10"><strong className="text-[11px] tracking-[.17em]">07 ARTISTES · 01 SCÈNE</strong><p className="m-0 text-[13px] leading-[1.65] text-[#5d5960]">Ajoute ici un texte souvenir de l’édition, les crédits photo/vidéo et les liens vers le vlog, les publications ou les performances.</p><span className="justify-self-start text-[11px] tracking-[.17em] text-[#ff66c4] min-[581px]:justify-self-end">TEXTE & LIENS À COMPLÉTER</span></div>
      </section>

      <section id="future" className={`${section} flex min-h-[80vh] flex-col items-center justify-center bg-[#f1efe9] text-center text-[#0a090b]`}><p className={index}>CHAPITRE 02</p><h2 className="m-0 text-[40px] leading-[.94] tracking-[-.065em] min-[380px]:text-[48px] min-[581px]:text-[clamp(54px,7vw,96px)] min-[581px]:leading-[.8] min-[581px]:tracking-[-.075em]">LA SUITE<br /><em className="font-[Georgia] font-normal text-[#ff66c4]">S’ÉCRIT MAINTENANT.</em></h2><div className="my-[35px] grid w-[min(560px,100%)] grid-cols-[auto_1fr] items-center gap-[22px] border border-black/30 p-[22px] text-left min-[581px]:my-[48px] min-[581px]:grid-cols-[auto_1fr_auto]"><span className="font-[Georgia] text-[26px] italic text-[#ff66c4]">02</span><strong className="text-xl">NUBE #2</strong><small className="col-start-2 text-[10px] tracking-[.18em] min-[581px]:col-auto">ARCHIVE À VENIR</small></div><a className="border-b border-black/50 pb-[7px] text-[11px] font-black tracking-[.17em]" href="/">RETOUR À NUBE </a></section>
    </main>
  );
}
